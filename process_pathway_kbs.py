...
path_kb_dirs = {"humancyc": paths.humancyc_raw_data_dir,
...
for kb_name, kb_dir in path_kb_dirs:
    kb = PathKB(kb_name, kb_dir)
    kb.dump_pickle(kb, os.path.join(paths.processed_data_dir, kb_name + '.pickle'))
